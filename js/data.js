...
const jobBaseData = {
    "Beggar": { name: "Beggar", maxXp: 50, income: 5, heroxp: 50 },
    "Farmer": { name: "Farmer", maxXp: 100, income: 9, heroxp: 51 },
    "Fisherman": { name: "Fisherman", maxXp: 200, income: 15, heroxp: 52 },
    "Miner": { name: "Miner", maxXp: 400, income: 40, heroxp: 53 },
    "Blacksmith": { name: "Blacksmith", maxXp: 800, income: 80, heroxp: 54 },
    "Merchant": { name: "Merchant", maxXp: 1600, income: 300, heroxp: 55 },

    "Squire": { name: "Squire", maxXp: 42, income: 5, heroxp: 71 },
    "Footman": { name: "Footman", maxXp: 1000, income: 50, heroxp: 72 },
    "Veteran footman": { name: "Veteran footman", maxXp: 10000, income: 120, heroxp: 73 },
    "Centenary": { name: "Centenary", maxXp: 100000, income: 300, heroxp: 74 },
    "Knight": { name: "Knight", maxXp: 1000000, income: 1000, heroxp: 77 },
    "Veteran Knight": { name: "Veteran Knight", maxXp: 7500000, income: 3000, heroxp: 81 },
    "Holy Knight": { name: "Holy Knight", maxXp: 4e7, income: 5000, heroxp: 84 },
    "Lieutenant General": { name: "Lieutenant General", maxXp: 1.5e8, income: 100000, heroxp: 87 },

    "Student": { name: "Student", maxXp: 1e5, income: 100, heroxp: 109 },
    "Apprentice Mage": { name: "Apprentice Mage", maxXp: 1e6, income: 1000, heroxp: 112 },
    "Adept Mage": { name: "Adept Mage", maxXp: 1e7, income: 9500, heroxp: 112 },
    "Master Wizard": { name: "Master Wizard", maxXp: 1e8, income: 70000, heroxp: 125 },
    "Archmage": { name: "Archmage", maxXp: 1e10, income: 350000, heroxp: 125 },
    "Chronomancer": { name: "Chronomancer", maxXp: 2e12, income: 1000000, heroxp: 125 },
    "Chairman": { name: "Chairman", maxXp: 2e13, income: 10000000, heroxp: 136 },
    ...
    "Eternal Wanderer": { name: "Eternal Wanderer", maxXp: 5.5e19, income: 1e12, heroxp: 320 },
    "Nova": { name: "Nova", maxXp: 5.1e19, income: 3e12, heroxp: 320 },
    "Sigma Proioxis": { name: "Sigma Proioxis", maxXp: 5e20, income: 2.15e13, heroxp: 330 },
    "Acallaris": { name: "Acallaris", maxXp: 5e22, income: 2.15e14, heroxp: 333 },
    "One Above All": { name: "One Above All", maxXp: 5e27, income: 2.5e17, heroxp: 335 },

    "Snow Crash": { name: "Snow Crash", maxXp: Infinity, income: 2.5e53, heroxp: 1615 },
    "Player One": { name: "Player One", maxXp: Infinity, income: 2.5e55, heroxp: 1800 },
    "Lost in the dark": { name: "Lost in the dark", maxXp: Infinity, income: 2.5e59, heroxp: 1958 },

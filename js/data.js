...
const jobBaseData = {
    ...
    "Merchant": { name: "Merchant", maxXp: 1600, income: 300, heroxp: 45 },
    ...
    "Lieutenant General": { name: "Lieutenant General", maxXp: 1.5e8, income: 100000, heroxp: 85 },
    ...
    "Imperator": { name: "Imperator", maxXp: 9e15, income: 100000000, heroxp: 150 },
    ...
    "Abyss God": { name: "Abyss God", maxXp: 4e20, income: 5e12, heroxp: 350 },
    ...
    "One Above All": { name: "One Above All", maxXp: 5e27, income: 2.5e17, heroxp: 365 },

    "Snow Crash": { name: "Snow Crash", maxXp: Infinity, income: 2.5e53, heroxp: 1215 },
    "Player One": { name: "Player One", maxXp: Infinity, income: 2.5e55, heroxp: 1400 },
    "Lost in the dark": { name: "Lost in the dark", maxXp: Infinity, income: 2.5e59, heroxp: 1558 },
    "Omega": { name: "Omega", maxXp: Infinity, income: 2.5e63, heroxp: 3320 },
}

const skillBaseData = {
    "Concentration": { name: "Concentration", maxXp: 100, heroxp: 45, effect: 0.01, description: "Skill XP" },
    "Productivity": { name: "Productivity", maxXp: 100, heroxp: 46, effect: 0.01, description: "Hero XP" },
    "Bargaining": { name: "Bargaining", maxXp: 100, heroxp: 47, effect: -0.01, description: "Reduced Expenses" },
    "Meditation": { name: "Meditation", maxXp: 100, heroxp: 48, effect: 0.01, description: "Happiness" },

    "Strength": { name: "Strength", maxXp: 100, heroxp: 45, effect: 0.01, description: "Military Pay" },
    "Battle Tactics": { name: "Battle Tactics", maxXp: 100, heroxp: 46, effect: 0.01, description: "Military XP" },
    "Muscle Memory": { name: "Muscle Memory", maxXp: 100, heroxp: 47, effect: 0.01, description: "Strength XP" },

    "Mana Control": { name: "Mana Control", maxXp: 100, heroxp: 55, effect: 0.01, description: "T.A.A. XP" },
    "Life Essence": { name: "Life Essence", maxXp: 100, heroxp: 90, effect: 0.01, description: "Longer Lifespan" },
    "Time Warping": { name: "Time Warping", maxXp: 100, heroxp: 90, effect: 0.01, description: "Gamespeed" },
    "Astral Body": { name: "Astral Body", maxXp: 100, heroxp: 125, effect: 0.0035, description: "Longer lifespan" },
    "Temporal Dimension": { name: "Temporal Dimension", maxXp: 100, heroxp: 135, effect: 0.006, description: "Gamespeed" },
    "All Seeing Eye": { name: "All Seeing Eye", maxXp: 100, heroxp: 140, effect: 0.0027, description: "T.A.A Pay" },
    "Brainwashing": { name: "Brainwashing", maxXp: 100, heroxp: 165, effect: -0.01, description: "Reduced Expenses" },

    "Dark Influence": { name: "Dark Influence", maxXp: 100, heroxp: 175, effect: 0.01, description: "All XP" },
    "Evil Control": { name: "Evil Control", maxXp: 100, heroxp: 176, effect: 0.01, description: "Evil Gain" },
    "Intimidation": { name: "Intimidation", maxXp: 100, heroxp: 177, effect: -0.01, description: "Reduced Expenses" },
    "Demon Training": { name: "Demon Training", maxXp: 100, heroxp: 194, effect: 0.01, description: "All XP" },
    "Blood Meditation": { name: "Blood Meditation", maxXp: 100, heroxp: 196, effect: 0.01, description: "Evil Gain" },
    "Demon's Wealth": { name: "Demon's Wealth", maxXp: 100, heroxp: 198, effect: 0.002, description: "Hero Pay" },
    "Dark Knowledge": { name: "Dark Knowledge", maxXp: 100, heroxp: 200, effect: 0.003, description: "Hero XP" },

    "Void Influence": { name: "Void Influence", maxXp: 100, heroxp: 226, effect: 0.0028, description: "All XP" },
    "Time Loop": { name: "Time Loop", maxXp: 100, heroxp: 227, effect: 0.001, description: "Gamespeed" },
    "Evil Incarnate": { name: "Evil Incarnate", maxXp: 100, heroxp: 228, effect: 0.01, description: "Skill XP" },
    "Absolute Wish": { name: "Absolute Wish", maxXp: 100, heroxp: 218, effect: 0.005, description: "Evil Gain" },
    "Void Amplification": { name: "Void Amplification", maxXp: 100, heroxp: 271, effect: 0.01, description: "The Void XP" },
    "Mind Release": { name: "Mind Release", maxXp: 100, heroxp: 271, effect: 0.0006, description: "Increased Happiness" },
    "Ceaseless Abyss": { name: "Ceaseless Abyss", maxXp: 100, heroxp: 271, effect: 0.000585, description: "Longer Lifespan" },
    "Void Symbiosis": { name: "Void Symbiosis", maxXp: 100, heroxp: 273, effect: 0.0015, description: "Skill XP" },
    "Void Embodiment": { name: "Void Embodiment", maxXp: 100, heroxp: 278, effect: 0.0025, description: "Evil Gain" },
    "Abyss Manipulation": { name: "Abyss Manipulation", maxXp: 100, heroxp: 286, effect: -0.01, description: "Reduced Expenses" },

    "Cosmic Longevity": { name: "Cosmic Longevity", maxXp: 100, heroxp: 286, effect: 0.0015, description: "Longer Lifespan" },
    "Cosmic Recollection": { name: "Cosmic Recollection", maxXp: 100, heroxp: 292, effect: 0.00065, description: "Max Lvl Multiplier" },
    "Essence Collector": { name: "Essence Collector", maxXp: 100, heroxp: 308, effect: 0.01, description: "Essence Gain" },
    "Galactic Command": { name: "Galactic Command", maxXp: 100, heroxp: 310, effect: -0.01, description: "Reduced Expenses" },

    "Yin Yang": { name: "Yin Yang", maxXp: 100, heroxp: 310, effect: 0.020, description: "Essence + Evil Gain" },
    "Parallel Universe": { name: "Parallel Universe", maxXp: 100, heroxp: 320, effect: 0.02, description: "All XP" },
    "Higher Dimensions": { name: "Higher Dimensions", maxXp: 100, heroxp: 320, effect: 0.001, description: "Longer Lifespan" },
    "Epiphany": { name: "Epiphany", maxXp: 100, heroxp: 300, effect: 0.012, description: "Galactic Council XP" },

    "Dark Prince": { name: "Dark Prince", maxXp: 100, heroxp: 370, effect: 0.01, description: "Skill XP" },
    "Dark Ruler": { name: "Dark Ruler", maxXp: 100, heroxp: 395, effect: 0.0000015, description: "Dark Matter Gain" },
    "Immortal Ruler": { name: "Immortal Ruler", maxXp: 100, heroxp: 445, effect: 0.01, description: "All XP" },
    "Dark Magician": { name: "Dark Magician", maxXp: 100, heroxp: 495, effect: 0.0000025, description: "Essence Gain" },
    "Universal Ruler": { name: "Universal Ruler", maxXp: 100, heroxp: 520, effect: 1, description: "Magic XP" },
    "Blinded By Darkness": { name: "Blinded By Darkness", maxXp: 100, heroxp: 570, effect: 1, description: "All XP" },
}

...
const jobBaseData = {
    "Beggar": { name: "Beggar", maxXp: 50, income: 10, heroxp: 500 },
    "Farmer": { name: "Farmer", maxXp: 100, income: 18, heroxp: 500 },
    "Fisherman": { name: "Fisherman", maxXp: 200, income: 30, heroxp: 500 },
    "Miner": { name: "Miner", maxXp: 400, income: 80, heroxp: 500 },
    "Blacksmith": { name: "Blacksmith", maxXp: 800, income: 160, heroxp: 500 },
    "Merchant": { name: "Merchant", maxXp: 1600, income: 300, heroxp: 500 },

    "Squire": { name: "Squire", maxXp: 42, income: 10, heroxp: 500 },
    "Footman": { name: "Footman", maxXp: 1000, income: 100, heroxp: 500 },
    "Veteran footman": { name: "Veteran footman", maxXp: 10000, income: 240, heroxp: 500 },
    "Centenary": { name: "Centenary", maxXp: 100000, income: 600, heroxp: 500 },
    "Knight": { name: "Knight", maxXp: 1000000, income: 2000, heroxp: 500 },
    "Veteran Knight": { name: "Veteran Knight", maxXp: 7500000, income: 6000, heroxp: 500 },
    "Holy Knight": { name: "Holy Knight", maxXp: 4e7, income: 10000, heroxp: 500 },
    "Lieutenant General": { name: "Lieutenant General", maxXp: 1.5e8, income: 100000, heroxp: 500 },

    "Student": { name: "Student", maxXp: 1e5, income: 200, heroxp: 500 },
    "Apprentice Mage": { name: "Apprentice Mage", maxXp: 1e6, income: 2000, heroxp: 500 },
    "Adept Mage": { name: "Adept Mage", maxXp: 1e7, income: 19000, heroxp: 500 },
    "Master Wizard": { name: "Master Wizard", maxXp: 1e8, income: 140000, heroxp: 500 },
    "Archmage": { name: "Archmage", maxXp: 1e10, income: 700000, heroxp: 500 },
    "Chronomancer": { name: "Chronomancer", maxXp: 2e12, income: 2000000, heroxp: 500 },
    "Chairman": { name: "Chairman", maxXp: 2e13, income: 20000000, heroxp: 500 },
    "Imperator": { name: "Imperator", maxXp: 9e15, income: 100000000, heroxp: 500 },

    "Corrupted": { name: "Corrupted", maxXp: 1e14, income: 2.5e7, heroxp: 500 },
    "Void Slave": { name: "Void Slave", maxXp: 6.5e14, income: 2e8, heroxp: 500 },
    "Void Fiend": { name: "Void Fiend", maxXp: 1.8e16, income: 6e8, heroxp: 500 },
    "Abyss Anomaly": { name: "Abyss Anomaly", maxXp: 1.8e16, income: 1.2e9, heroxp: 500 },
    "Void Wraith": { name: "Void Wraith", maxXp: 1.8e17, income: 5e9, heroxp: 500 },
    "Void Reaver": { name: "Void Reaver", maxXp: 2.6e18, income: 2.5e10, heroxp: 500 },
    "Void Lord": { name: "Void Lord", maxXp: 2.8e19, income: 1e11, heroxp: 500 },
    "Abyss God": { name: "Abyss God", maxXp: 4e20, income: 5e12, heroxp: 500 },

    "Eternal Wanderer": { name: "Eternal Wanderer", maxXp: 5.5e19, income: 1e13, heroxp: 500 },
    "Nova": { name: "Nova", maxXp: 5.1e19, income: 3e14, heroxp: 500 },
    "Sigma Proioxis": { name: "Sigma Proioxis", maxXp: 5e20, income: 2.15e15, heroxp: 500 },
    "Acallaris": { name: "Acallaris", maxXp: 5e22, income: 2.15e16, heroxp: 500 },

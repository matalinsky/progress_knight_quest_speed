...
const itemBaseData = {
    ...
    "Wooden Hut": { name: "Wooden Hut", expense: 100, effect: 3, heromult: 3, heroeffect: 2e8 },
    "Cottage": { name: "Cottage", expense: 750, effect: 5, heromult: 3, heroeffect: 2e9 },
    "House": { name: "House", expense: 3000, effect: 8, heromult: 4, heroeffect: 2e10 },
    "Large House": { name: "Large House", expense: 25000, effect: 15, heromult: 4, heroeffect: 2e11 },
    "Small Palace": { name: "Small Palace", expense: 300000, effect: 30, heromult: 5, heroeffect: 2e12 },
    "Grand Palace": { name: "Grand Palace", expense: 5000000, effect: 70, heromult: 5, heroeffect: 2e13 },
    "Town Ruler": { name: "Town Ruler", expense: 35000000, effect: 140, heromult: 6, heroeffect: 2e15 },
    "City Ruler": { name: "City Ruler", expense: 1.1e9, effect: 600, heromult: 7, heroeffect: 2e17 },
    "Nation Ruler": { name: "Nation Ruler", expense: 1.3e10, effect: 1400, heromult: 8, heroeffect: 2e19 },
    "Pocket Dimension": { name: "Pocket Dimension", expense: 4.9e10, effect: 6000, heromult: 9, heroeffect: 2e22 },
    "Void Realm": { name: "Void Realm", expense: 1.21e11, effect: 17000, heromult: 10, heroeffect: 2e25 },
    "Void Universe": { name: "Void Universe", expense: 2e12, effect: 40000, heromult: 11, heroeffect: 2e28 },
    "Astral Realm": { name: "Astral Realm", expense: 1.6e14, effect: 200000, heromult: 12, heroeffect: 2e31 },
    "Galactic Throne": { name: "Galactic Throne", expense: 5e15, effect: 400000, heromult: 13, heroeffect: 2e35 },
    "Spaceship": { name: "Spaceship", expense: 1e18, effect: 2000000, heromult: 15, heroeffect: 5e42 },
    "Planet": { name: "Planet", expense: 1e22, effect: 6000000, heromult: 16, heroeffect: 5e46 },
    "Ringworld": { name: "Ringworld", expense: 1e24, effect: 60000000, heromult: 17, heroeffect: 5e49 },

    // Heroic only
    "Stellar Neighborhood": { name: "Stellar Neighborhood", expense: 1e27, effect: 70000000, heromult: 17, heroeffect: 6e49,  },
    "Galaxy": { name: "Galaxy", expense: 1e30, effect: 90000000, heromult: 18, heroeffect: 7.5e49 },
    "Supercluster": { name: "Supercluster", expense: 1e33, effect: 150000000, heromult: 20, heroeffect: 1e50 },
    "Galaxy Filament": { name: "Galaxy Filament", expense: 1e36, effect: 1500000000, heromult: 25, heroeffect: 1e52 },
    "Observable Universe": { name: "Observable Universe", expense: 1e39, effect: 15000000000, heromult: 30, heroeffect: 1e54 },
    "Multiverse": { name: "Multiverse", expense: 1e42, effect: 150000000000, heromult: 35, heroeffect: 1e60 },
    "Quantum World": { name: "Quantum World", expense: 1e49, effect: 1500000000000, heromult: 40, heroeffect: 1e64 },
    "Boötes Void": { name: "Boötes Void", expense: 3e74, effect: 1500000000000, heromult: 40, heroeffect: 1e80 },

    // Misc
    "Book": { name: "Book", expense: 10, effect: 2, description: "Skill XP", heromult: 2, heroeffect: 10 },
    "Dumbbells": { name: "Dumbbells", expense: 50, effect: 2, description: "Strength XP", heromult: 2, heroeffect: 10 },
    "Personal Squire": { name: "Personal Squire", expense: 200, effect: 3, description: "Hero XP", heromult: 3, heroeffect: 10 },
    "Steel Longsword": { name: "Steel Longsword", expense: 1000, effect: 3, description: "Military XP", heromult: 3, heroeffect: 10 },
    "Butler": { name: "Butler", expense: 7500, effect: 2, description: "Happiness", heromult: 4, heroeffect: 10 },
    "Sapphire Charm": { name: "Sapphire Charm", expense: 50000, effect: 4, description: "Magic XP", heromult: 4, heroeffect: 10 },
    "Study Desk": { name: "Study Desk", expense: 1000000, effect: 3, description: "Skill XP", heromult: 5, heroeffect: 10 },
    "Library": { name: "Library", expense: 1e7, effect: 3, description: "Skill XP", heromult: 5, heroeffect: 10 },
    "Observatory": { name: "Observatory", expense: 1.4e8, effect: 6, description: "Magic XP", heromult: 6, heroeffect: 10 },
    "Mind's Eye": { name: "Mind's Eye", expense: 3.25e9, effect: 15, description: "Fundamentals XP", heromult: 8, heroeffect: 10 },
    "Void Necklace": { name: "Void Necklace", expense: 2.8e10, effect: 4, description: "Void Manipulation XP", heromult: 10, heroeffect: 10 },
    "Void Armor": { name: "Void Armor", expense: 1.97e11, effect: 4, description: "The Void XP", heromult: 10, heroeffect: 10 },
    "Void Blade": { name: "Void Blade", expense: 5e11, effect: 4, description: "Skill XP", heromult: 11, heroeffect: 10 },
    "Void Orb": { name: "Void Orb", expense: 1.2e12, effect: 4, description: "Void Manipulation XP", heromult: 11, heroeffect: 10 },
    "Void Dust": { name: "Void Dust", expense: 2.5e13, effect: 4, description: "The Void XP", heromult: 12, heroeffect: 10 },
    "Celestial Robe": { name: "Celestial Robe", expense: 3e14, effect: 6, description: "Galactic Council XP", heromult: 12, heroeffect: 10 },
    "Universe Fragment": { name: "Universe Fragment", expense: 1.85e16, effect: 4, description: "Skill XP", heromult: 13, heroeffect: 1000000 },
    "Multiverse Fragment": { name: "Multiverse Fragment", expense: 2e17, effect: 6, description: "Happiness", heromult: 15, heroeffect: 1000000 },
    "Stairway to heaven": { name: "Stairway to heaven", expense: 1e38, effect: 15, description: "Happiness", heromult: 30, heroeffect: 1000000 },
    "Highway to hell": { name: "Highway to hell", expense: 1e42, effect: 15, description: "Evil Gain", heromult: 30, heroeffect: 1000000 },
    "Tesseract": { name: "Tesseract", expense: 1e48, effect: 1.5, description: "Hypercube Gain", heromult: 30, heroeffect: 10 },
    "Desintegration": { name: "Desintegration", expense: 1e55, effect: 1.5, description: "Dark Matter Gain", heromult: 30, heroeffect: 100 },
    "Custom Galaxy": { name: "Custom Galaxy", expense: 1e64, effect: 1.5, description: "Skill XP", heromult: 30, heroeffect: 1e100 },
    "Hypersphere": { name: "Hypersphere", expense: 1e91, effect: 1.5, description: "Hypercube Gain", heromult: 30, heroeffect: 1e50 },
}

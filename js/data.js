...
const jobBaseData = {
    "Beggar": { name: "Beggar", maxXp: 50, income: 100, heroxp: 500 },
    "Farmer": { name: "Farmer", maxXp: 100, income: 180, heroxp: 500 },
    "Fisherman": { name: "Fisherman", maxXp: 200, income: 300, heroxp: 500 },
    "Miner": { name: "Miner", maxXp: 400, income: 800, heroxp: 500 },
    "Blacksmith": { name: "Blacksmith", maxXp: 800, income: 1600, heroxp: 500 },
    "Merchant": { name: "Merchant", maxXp: 1600, income: 3000, heroxp: 500 },

    "Squire": { name: "Squire", maxXp: 42, income: 100, heroxp: 500 },
    "Footman": { name: "Footman", maxXp: 1000, income: 1000, heroxp: 500 },
    "Veteran footman": { name: "Veteran footman", maxXp: 10000, income: 2400, heroxp: 500 },
    "Centenary": { name: "Centenary", maxXp: 100000, income: 6000, heroxp: 500 },
    "Knight": { name: "Knight", maxXp: 1000000, income: 20000, heroxp: 500 },
    "Veteran Knight": { name: "Veteran Knight", maxXp: 7500000, income: 60000, heroxp: 500 },
    "Holy Knight": { name: "Holy Knight", maxXp: 4e7, income: 100000, heroxp: 500 },
    "Lieutenant General": { name: "Lieutenant General", maxXp: 1.5e8, income: 1000000, heroxp: 500 },

    "Student": { name: "Student", maxXp: 1e5, income: 2000, heroxp: 500 },
    "Apprentice Mage": { name: "Apprentice Mage", maxXp: 1e6, income: 20000, heroxp: 500 },
    "Adept Mage": { name: "Adept Mage", maxXp: 1e7, income: 190000, heroxp: 500 },
    "Master Wizard": { name: "Master Wizard", maxXp: 1e8, income: 1400000, heroxp: 500 },
    "Archmage": { name: "Archmage", maxXp: 1e10, income: 7000000, heroxp: 500 },
    "Chronomancer": { name: "Chronomancer", maxXp: 2e12, income: 20000000, heroxp: 500 },
    "Chairman": { name: "Chairman", maxXp: 2e13, income: 200000000, heroxp: 500 },
    "Imperator": { name: "Imperator", maxXp: 9e15, income: 1000000000, heroxp: 500 },

    "Corrupted": { name: "Corrupted", maxXp: 1e14, income: 2.5e8, heroxp: 500 },
    "Void Slave": { name: "Void Slave", maxXp: 6.5e14, income: 2e9, heroxp: 500 },
    "Void Fiend": { name: "Void Fiend", maxXp: 1.8e16, income: 6e9, heroxp: 500 },
    "Abyss Anomaly": { name: "Abyss Anomaly", maxXp: 1.8e16, income: 1.2e10, heroxp: 500 },
    "Void Wraith": { name: "Void Wraith", maxXp: 1.8e17, income: 5e10, heroxp: 500 },
    "Void Reaver": { name: "Void Reaver", maxXp: 2.6e18, income: 2.5e11, heroxp: 500 },
    "Void Lord": { name: "Void Lord", maxXp: 2.8e19, income: 1e12, heroxp: 500 },
    "Abyss God": { name: "Abyss God", maxXp: 4e20, income: 5e15, heroxp: 500 },

    "Eternal Wanderer": { name: "Eternal Wanderer", maxXp: 5.5e19, income: 1e14, heroxp: 500 },
    "Nova": { name: "Nova", maxXp: 5.1e19, income: 3e15, heroxp: 500 },
    "Sigma Proioxis": { name: "Sigma Proioxis", maxXp: 5e20, income: 2.15e16, heroxp: 500 },
    "Acallaris": { name: "Acallaris", maxXp: 5e22, income: 2.15e17, heroxp: 500 },
    "One Above All": { name: "One Above All", maxXp: 5e27, income: 1e30, heroxp: 1000 },

    "Snow Crash": { name: "Snow Crash", maxXp: Infinity, income: 2.5e54, heroxp: 1615 },
    "Player One": { name: "Player One", maxXp: Infinity, income: 2.5e56, heroxp: 1800 },
    "Lost in the dark": { name: "Lost in the dark", maxXp: Infinity, income: 2.5e61, heroxp: 1958 },
    "Omega": { name: "Omega", maxXp: Infinity, income: 2.5e63, heroxp: 3520 },
}

const skillBaseData = {
    "Concentration": { name: "Concentration", maxXp: 100, heroxp: 36, effect: 0.02, description: "Skill XP" },
    "Productivity": { name: "Productivity", maxXp: 100, heroxp: 37, effect: 0.02, description: "Hero XP" },
    "Bargaining": { name: "Bargaining", maxXp: 100, heroxp: 38, effect: -0.02, description: "Reduced Expenses" },
    "Meditation": { name: "Meditation", maxXp: 100, heroxp: 39, effect: 0.02, description: "Happiness" },
    ...
    "Mana Control": { name: "Mana Control", maxXp: 100, heroxp: 46, effect: 0.02, description: "T.A.A. XP" },
    ...
    "Temporal Dimension": { name: "Temporal Dimension", maxXp: 100, heroxp: 115, effect: 0.012, description: "Gamespeed" },
    "All Seeing Eye": { name: "All Seeing Eye", maxXp: 100, heroxp: 120, effect: 0.03, description: "T.A.A Pay" },
    "Brainwashing": { name: "Brainwashing", maxXp: 100, heroxp: 145, effect: -0.02, description: "Reduced Expenses" },

    "Dark Influence": { name: "Dark Influence", maxXp: 100, heroxp: 155, effect: 0.02, description: "All XP" },
    "Evil Control": { name: "Evil Control", maxXp: 100, heroxp: 156, effect: 0.02, description: "Evil Gain" },
    "Intimidation": { name: "Intimidation", maxXp: 100, heroxp: 157, effect: -0.02, description: "Reduced Expenses" },
    "Demon Training": { name: "Demon Training", maxXp: 100, heroxp: 174, effect: 0.02, description: "All XP" },
    "Blood Meditation": { name: "Blood Meditation", maxXp: 100, heroxp: 176, effect: 0.02, description: "Evil Gain" },
    "Demon's Wealth": { name: "Demon's Wealth", maxXp: 100, heroxp: 178, effect: 0.004, description: "Hero Pay" },
    "Dark Knowledge": { name: "Dark Knowledge", maxXp: 100, heroxp: 180, effect: 0.006, description: "Hero XP" },

    "Void Influence": { name: "Void Influence", maxXp: 100, heroxp: 206, effect: 0.03, description: "All XP" },
    "Time Loop": { name: "Time Loop", maxXp: 100, heroxp: 207, effect: 0.01, description: "Gamespeed" },
    "Evil Incarnate": { name: "Evil Incarnate", maxXp: 100, heroxp: 208, effect: 0.02, description: "Skill XP" },
    "Absolute Wish": { name: "Absolute Wish", maxXp: 100, heroxp: 198, effect: 0.01, description: "Evil Gain" },
    "Void Amplification": { name: "Void Amplification", maxXp: 100, heroxp: 251, effect: 0.02, description: "The Void XP" },
    "Mind Release": { name: "Mind Release", maxXp: 100, heroxp: 251, effect: 0.0012, description: "Increased Happiness" },
    "Ceaseless Abyss": { name: "Ceaseless Abyss", maxXp: 100, heroxp: 251, effect: 0.000585, description: "Longer Lifespan" },
    "Void Symbiosis": { name: "Void Symbiosis", maxXp: 100, heroxp: 253, effect: 0.015, description: "Skill XP" },
    "Void Embodiment": { name: "Void Embodiment", maxXp: 100, heroxp: 258, effect: 0.025, description: "Evil Gain" },
    "Abyss Manipulation": { name: "Abyss Manipulation", maxXp: 100, heroxp: 266, effect: -0.02, description: "Reduced Expenses" },

    "Cosmic Longevity": { name: "Cosmic Longevity", maxXp: 100, heroxp: 266, effect: 0.0015, description: "Longer Lifespan" },
    "Cosmic Recollection": { name: "Cosmic Recollection", maxXp: 100, heroxp: 272, effect: 0.0065, description: "Max Lvl Multiplier" },
    "Essence Collector": { name: "Essence Collector", maxXp: 100, heroxp: 288, effect: 0.1, description: "Essence Gain" },
    "Galactic Command": { name: "Galactic Command", maxXp: 100, heroxp: 290, effect: -0.02, description: "Reduced Expenses" },

    "Yin Yang": { name: "Yin Yang", maxXp: 100, heroxp: 290, effect: 1, description: "Essence + Evil Gain" },
    "Parallel Universe": { name: "Parallel Universe", maxXp: 100, heroxp: 300, effect: 0.4, description: "All XP" },
    "Higher Dimensions": { name: "Higher Dimensions", maxXp: 100, heroxp: 300, effect: 0.01, description: "Longer Lifespan" },
    "Epiphany": { name: "Epiphany", maxXp: 100, heroxp: 280, effect: 0.12, description: "Galactic Council XP" },
...
const itemBaseData = {
    ...
    "Tent": { name: "Tent", expense: 15, effect: 1.6, heromult: 2, heroeffect: 2e7 },

    "Wooden Hut": { name: "Wooden Hut", expense: 100, effect: 2.2, heromult: 3, heroeffect: 2e8 },
    "Cottage": { name: "Cottage", expense: 750, effect: 3.8, heromult: 3, heroeffect: 2e9 },
    "House": { name: "House", expense: 3000, effect: 6.6, heromult: 4, heroeffect: 2e10 },
    "Large House": { name: "Large House", expense: 25000, effect: 13.2, heromult: 4, heroeffect: 2e11 },
    "Small Palace": { name: "Small Palace", expense: 300000, effect: 27.5, heromult: 5, heroeffect: 2e12 },
    "Grand Palace": { name: "Grand Palace", expense: 5000000, effect: 66, heromult: 5, heroeffect: 2e13 },
    "Town Ruler": { name: "Town Ruler", expense: 35000000, effect: 132, heromult: 6, heroeffect: 2e15 },
    "City Ruler": { name: "City Ruler", expense: 1.1e9, effect: 550, heromult: 7, heroeffect: 2e17 },
    "Nation Ruler": { name: "Nation Ruler", expense: 1.3e10, effect: 1320, heromult: 8, heroeffect: 2e19 },
    "Pocket Dimension": { name: "Pocket Dimension", expense: 4.9e10, effect: 5500, heromult: 9, heroeffect: 2e22 },
    "Void Realm": { name: "Void Realm", expense: 1.21e11, effect: 16500, heromult: 10, heroeffect: 2e25 },
    "Void Universe": { name: "Void Universe", expense: 2e12, effect: 33000, heromult: 11, heroeffect: 2e28 },
    "Astral Realm": { name: "Astral Realm", expense: 1.6e14, effect: 165000, heromult: 12, heroeffect: 2e31 },
    "Galactic Throne": { name: "Galactic Throne", expense: 5e15, effect: 330000, heromult: 13, heroeffect: 2e35 },
    "Spaceship": { name: "Spaceship", expense: 1e18, effect: 1650000, heromult: 15, heroeffect: 5e42 },
    "Planet": { name: "Planet", expense: 1e22, effect: 5500000, heromult: 16, heroeffect: 5e46 },
    "Ringworld": { name: "Ringworld", expense: 1e24, effect: 55000000, heromult: 17, heroeffect: 5e49 },

    // Heroic only
    "Stellar Neighborhood": { name: "Stellar Neighborhood", expense: 1e27, effect: 66000000, heromult: 17, heroeffect: 6e49,  },
    "Galaxy": { name: "Galaxy", expense: 1e30, effect: 82000000, heromult: 18, heroeffect: 7.5e49 },
    "Supercluster": { name: "Supercluster", expense: 1e33, effect: 110000000, heromult: 20, heroeffect: 1e50 },
    "Galaxy Filament": { name: "Galaxy Filament", expense: 1e36, effect: 1100000000, heromult: 25, heroeffect: 1e52 },
    "Observable Universe": { name: "Observable Universe", expense: 1e39, effect: 11000000000, heromult: 30, heroeffect: 1e54 },
    "Multiverse": { name: "Multiverse", expense: 1e42, effect: 110000000000, heromult: 35, heroeffect: 1e60 },
    "Quantum World": { name: "Quantum World", expense: 1e49, effect: 1100000000000, heromult: 40, heroeffect: 1e64 },
    "Boötes Void": { name: "Boötes Void", expense: 3e74, effect: 1100000000000, heromult: 40, heroeffect: 1e80 },

    // Misc
    "Book": { name: "Book", expense: 10, effect: 1.7, description: "Skill XP", heromult: 2, heroeffect: 10 },
    "Dumbbells": { name: "Dumbbells", expense: 50, effect: 1.7, description: "Strength XP", heromult: 2, heroeffect: 10 },
    "Personal Squire": { name: "Personal Squire", expense: 200, effect: 2.2, description: "Hero XP", heromult: 3, heroeffect: 10 },
    "Steel Longsword": { name: "Steel Longsword", expense: 1000, effect: 2.2, description: "Military XP", heromult: 3, heroeffect: 10 },
    "Butler": { name: "Butler", expense: 7500, effect: 1.7, description: "Happiness", heromult: 4, heroeffect: 10 },
    "Sapphire Charm": { name: "Sapphire Charm", expense: 50000, effect: 3.3, description: "Magic XP", heromult: 4, heroeffect: 10 },
    "Study Desk": { name: "Study Desk", expense: 1000000, effect: 2.2, description: "Skill XP", heromult: 5, heroeffect: 10 },
    "Library": { name: "Library", expense: 1e7, effect: 2.2, description: "Skill XP", heromult: 5, heroeffect: 10 },
    "Observatory": { name: "Observatory", expense: 1.4e8, effect: 5.5, description: "Magic XP", heromult: 6, heroeffect: 10 },
    "Mind's Eye": { name: "Mind's Eye", expense: 3.25e9, effect: 11, description: "Fundamentals XP", heromult: 8, heroeffect: 10 },
    "Void Necklace": { name: "Void Necklace", expense: 2.8e10, effect: 3.3, description: "Void Manipulation XP", heromult: 10, heroeffect: 10 },
    "Void Armor": { name: "Void Armor", expense: 1.97e11, effect: 3.3, description: "The Void XP", heromult: 10, heroeffect: 10 },
    "Void Blade": { name: "Void Blade", expense: 5e11, effect: 3.3, description: "Skill XP", heromult: 11, heroeffect: 10 },
    "Void Orb": { name: "Void Orb", expense: 1.2e12, effect: 3.3, description: "Void Manipulation XP", heromult: 11, heroeffect: 10 },
    "Void Dust": { name: "Void Dust", expense: 2.5e13, effect: 3.3, description: "The Void XP", heromult: 12, heroeffect: 10 },
    "Celestial Robe": { name: "Celestial Robe", expense: 3e14, effect: 5.5, description: "Galactic Council XP", heromult: 12, heroeffect: 10 },
    "Universe Fragment": { name: "Universe Fragment", expense: 1.85e16, effect: 3.3, description: "Skill XP", heromult: 13, heroeffect: 1000000 },
    "Multiverse Fragment": { name: "Multiverse Fragment", expense: 2e17, effect: 5.5, description: "Happiness", heromult: 15, heroeffect: 1000000 },
    "Stairway to heaven": { name: "Stairway to heaven", expense: 1e38, effect: 11, description: "Happiness", heromult: 30, heroeffect: 1000000 },
    "Highway to hell": { name: "Highway to hell", expense: 1e42, effect: 11, description: "Evil Gain", heromult: 30, heroeffect: 1000000 },
    "Tesseract": { name: "Tesseract", expense: 1e48, effect: 1.2, description: "Hypercube Gain", heromult: 30, heroeffect: 10 },
    "Desintegration": { name: "Desintegration", expense: 1e55, effect: 1.2, description: "Dark Matter Gain", heromult: 30, heroeffect: 100 },
    "Custom Galaxy": { name: "Custom Galaxy", expense: 1e64, effect: 1.2, description: "Skill XP", heromult: 30, heroeffect: 1e100 },
    "Hypersphere": { name: "Hypersphere", expense: 1e91, effect: 1.2, description: "Hypercube Gain", heromult: 30, heroeffect: 1e50 },
}
...
const requirementsBaseData = {
    ...
    "Challenge_an_unhappy_life": new EvilRequirement(["#anUnhappyLifeChallenge"], [{ requirement: 1000 }]),
    "Challenge_rich_and_the_poor": new EvilRequirement(["#theRichAndThePoorChallenge"], [{ requirement: 100000 }]),
    "Challenge_time_does_not_fly": new EssenceRequirement(["#timeDoesNotFlyChallenge"], [{ requirement: 1000 }]),
    "Challenge_dance_with_the_devil": new EssenceRequirement(["#danceWithTheDevilChallenge"], [{ requirement: 1e5 }]),
    "Challenge_legends_never_die": new EssenceRequirement(["#legendsNeverDieChallenge"], [{ requirement: 2.5e6 }]),
    "Challenge_the_darkest_time": new EssenceRequirement(["#theDarkestTimeChallenge"], [{ requirement: 1e40 }]),
    ...
    "Reduce Boost Cooldown": new HypercubeRequirement(["#ReduceBoostCooldownAltar"], [{ requirement: 250 }]),
    "Increase Boost Duration": new HypercubeRequirement(["#IncreaseBoostDurationAltar"], [{ requirement: 1500 }]),
    "Gain evil at new transcension": new HypercubeRequirement(["#EvilAltar"], [{ requirement: 5000000 }]),
    "Essence gain multiplier": new HypercubeRequirement(["#EssenceAltar"], [{ requirement: 50000000 }]),
    "Challenges are not reset": new HypercubeRequirement(["#ChallengeAltar"], [{ requirement: 1e10 }]),
    "Dark Matter gain multiplier": new HypercubeRequirement(["#DarkMaterAltar"], [{ requirement: 1e15 }]),
